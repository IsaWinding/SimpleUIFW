...
public static class AddressLoadManager 
{
    ...
    public static int LoadAsync(string pPath, System.Action<UnityEngine.Object,int> pCB, bool IsGameObject = true, System.Action<int> pAssetIdCB = null)
    {
        assetId++;
    ...
    {
        assetId++;
        AddressLoader loader = new AddressLoader(assetId, pPath,null);
    ...
    public static int LoadByResTypeAndName(string pResType,string pResName, System.Action<UnityEngine.Object,int> pCB, bool IsGameObject = true, System.Action<int> pAssetIdCB = null)
    {
        ...
        return AddressLoadManager.LoadAsync(editorPath, pCB, IsGameObject, pAssetIdCB);
    }
}
